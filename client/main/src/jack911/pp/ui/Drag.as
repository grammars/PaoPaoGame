package jack911.pp.ui
{
	...
	public class Drag
	{
		...
		public function start(pImg:DisplayObject, action:String, data:Object):void
		{
			...
			Base.stage.addEventListener(Event.ENTER_FRAME, __following);
			Base.stage.addEventListener(MouseEvent.MOUSE_UP, __stageMouseUp);
		}
		...
		public function finish():void
		{
			...
			Base.stage.removeEventListener(Event.ENTER_FRAME, __following);
			Base.stage.removeEventListener(MouseEvent.MOUSE_UP, __stageMouseUp);
		}
		...
		private function __following(e:Event):void
		{
			if(pImg)
			{
				pImg.x = Base.stage.mouseX - pImg.width/2;
				pImg.y = Base.stage.mouseY - pImg.height/2;
			}
		}
