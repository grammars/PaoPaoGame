package com.anstu.jsock.utils
{
	...
	public class EndianFacade
	{
		...
		/** readString */
		static public function readString(source:IDataInput, length:int=-1, charset:String=CharsetConst.UTF8):String
		{
			return readMultiByte(source, length, charset);
		}
		
		/** writeString */
		static public function writeString(destination:IDataOutput, value:String, length:int=-1, charset:String=CharsetConst.UTF8):void
		{
			writeMultiByte(destination, value, length, charset);
		}
